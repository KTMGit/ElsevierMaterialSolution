...
namespace ElsevierMaterials.Exporter.Formats
{
    public class LsDyna
    {
        ...
        public static string FillMat1(int vkKey, IList<ExportPropertyGeneral> properties)
        {
            ...
            exportString = exportString + FormatDektetProperty(TMPropertyTypeEnum.PhysicalDensity, properties);
            exportString = exportString + FormatDektetProperty(TMPropertyTypeEnum.PhysicalModulusOfElasticity, properties);
            exportString = exportString + FormatDektetProperty(TMPropertyTypeEnum.PhysicalPoissonCoefficient, properties);
        ...
        public static string FillMat24(IList<ExportPropertyGeneral> properties)
        {
            ...
            exportString = exportString + FormatDektetProperty(TMPropertyTypeEnum.PhysicalModulusOfElasticity, properties);
            exportString = exportString + FormatDektetProperty(TMPropertyTypeEnum.PhysicalPoissonCoefficient, properties);
            IList<Value> values = (from u in properties where u.Type == TMPropertyTypeEnum.PlasticStrainStress select u.Values).FirstOrDefault();
            ...
            exportString = exportString + FormatDektetProperty(TMPropertyTypeEnum.PlasticStrainStress, properties);
        ...
        /// <param name="exportConatiner">The export conatiner.</param>
        /// <returns></returns>
        private static string FormatDektetProperty(TMPropertyTypeEnum type,  IList<ExportPropertyGeneral>  properties)
        {
            string value = "";
            ...
            if (type == TMPropertyTypeEnum.PlasticStrainStress)
            {
