...
namespace ElsevierMaterials.Exporter.Formats
{
    public class NASTRAN
    {
        ...
        public static string FillNASTRAN(int vkKey, string standard, string name,  IList<ExportPropertyGeneral> properties)
        {
            ...
            exportString = exportString + FormatOctet(properties, PropertyTypeEnum.PhysicalModulusOfElasticity, TypeOfOctet.Left) + EMPTYOCTET;
            exportString = exportString + FormatOctet(properties, PropertyTypeEnum.PhysicalPoissonCoefficient, TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties, PropertyTypeEnum.PhysicalDensity, TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties, PropertyTypeEnum.PhysicalMeanCoeffThermalExpansion, TypeOfOctet.Left);
        ...
        /// <returns></returns>
        public static String FillOctet(double value, TypeOfOctet type, PropertyTypeEnum exportType) 
        {
