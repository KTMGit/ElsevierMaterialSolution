...
namespace ElsevierMaterials.Exporter.Formats
{
    public  static class AltairHyperworks
    {
        ...
        public static string MAT1Export(IList<ExportPropertyGeneral> properties, string name, string standard)
        {
            ...
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.PhysicalModulusOfElasticity).FirstOrDefault(),TypeOfOctet.Left) + EMPTYOCTET;
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.PhysicalPoissonCoefficient).FirstOrDefault(), TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.PhysicalDensity).FirstOrDefault(), TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.PhysicalMeanCoeffThermalExpansion).FirstOrDefault(), TypeOfOctet.Left);     
        ...
        public static string MAT4Export(IList<ExportPropertyGeneral> properties, string name, string standard)
        {
            ...
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.PhysicalThermalConductivity).FirstOrDefault(), TypeOfOctet.Right) + EMPTYOCTET;
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.PhysicalDensity).FirstOrDefault(), TypeOfOctet.Right);          
        ...
        public static string MATFATSNExport(IList<ExportPropertyGeneral> properties, string name, string standard)
        {
            ...
            exportString = exportString + PLUS + STATIC + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.MechanicalYield).FirstOrDefault(), TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.MechanicalTensile).FirstOrDefault(), TypeOfOctet.Left) + System.Environment.NewLine;
            exportString = exportString + PLUS + SN + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.FatigueA).FirstOrDefault(), TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.FatigueB).FirstOrDefault(), TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.FatigueNf_maxSNDiagram).FirstOrDefault(), TypeOfOctet.Left) + EMPTYOCTET;
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.FatigueLimit).FirstOrDefault(), TypeOfOctet.Left)  +System.Environment.NewLine;
        ...
        public static string MATFATENExport(IList<ExportPropertyGeneral> properties, string name, string standard)
        {
            ...
            exportString = exportString + PLUS + EN + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.FatigueStrengthCoefficient).FirstOrDefault(), TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.FatigueStrengthExponent).FirstOrDefault(), TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.FatigueDuctilityExponent).FirstOrDefault(), TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.FatigueDuctilityCoefficient).FirstOrDefault(), TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.FatigueCyclicStrengthExponent).FirstOrDefault(), TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.FatigueCyclicStrengthCoefficient).FirstOrDefault(), TypeOfOctet.Left);
            exportString = exportString + FormatOctet(properties.Where(u => u.Type == PropertyTypeEnum.FatigueNf_maxENDiagram).FirstOrDefault(), TypeOfOctet.Left) + System.Environment.NewLine;
        ...
        {
            if ((from u in properties where u.Type == PropertyTypeEnum.PhysicalModulusOfElasticity || u.Type == PropertyTypeEnum.PhysicalPoissonCoefficient || u.Type == PropertyTypeEnum.PhysicalDensity || u.Type == PropertyTypeEnum.PhysicalMeanCoeffThermalExpansion select u).Any())
            {
                return true;
            }
            return false;
        ...
        {
            if ((from u in properties where u.Type == PropertyTypeEnum.PhysicalThermalConductivity || u.Type == PropertyTypeEnum.PhysicalDensity select u).Any())
            {
                return true;
            }
            return false;
        ...
        {
            if ((from u in properties where u.Type == PropertyTypeEnum.PhysicalModulusOfElasticity || u.Type == PropertyTypeEnum.PhysicalPoissonCoefficient || u.Type == PropertyTypeEnum.PhysicalDensity || u.Type == PropertyTypeEnum.MechanicalYield || u.Type == PropertyTypeEnum.MechanicalTensile || u.Type == PropertyTypeEnum.FatigueStrengthCoefficient || u.Type == PropertyTypeEnum.FatigueStrengthExponent || u.Type == PropertyTypeEnum.FatigueDuctilityExponent || u.Type == PropertyTypeEnum.FatigueDuctilityCoefficient || u.Type == PropertyTypeEnum.FatigueCyclicStrengthExponent || u.Type == PropertyTypeEnum.FatigueCyclicStrengthCoefficient || u.Type == PropertyTypeEnum.FatigueNf_maxENDiagram select u).Any())
            {
                return true;
            }
            return false;
        ...
        {
            if ((from u in properties where u.Type == PropertyTypeEnum.PhysicalModulusOfElasticity || u.Type == PropertyTypeEnum.PhysicalPoissonCoefficient || u.Type == PropertyTypeEnum.PhysicalDensity || u.Type == PropertyTypeEnum.PhysicalMeanCoeffThermalExpansion || u.Type == PropertyTypeEnum.MechanicalYield || u.Type == PropertyTypeEnum.MechanicalTensile || u.Type == PropertyTypeEnum.FatigueA || u.Type == PropertyTypeEnum.FatigueB || u.Type == PropertyTypeEnum.FatigueNf_maxSNDiagram || u.Type == PropertyTypeEnum.FatigueLimit select u).Any())
            {
                return true;
            }
            return false;
        ...
        {
            if ((from u in properties where u.Type == PropertyTypeEnum.PhysicalModulusOfElasticity || u.Type == PropertyTypeEnum.PhysicalPoissonCoefficient || u.Type == PropertyTypeEnum.MechanicalYield || u.Type == PropertyTypeEnum.StressStrain select u).Any())
            {
                return true;
            }
            return false;
