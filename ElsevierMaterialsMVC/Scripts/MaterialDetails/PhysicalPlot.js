...
// model for all  physical properties
...
//
physicalPlot.InitData = function (modelValue) {
    diagramData = $.parseJSON(modelValue).Properties;
    //console.log('Diagram Data', diagramData)
};

physicalPlot.InitDataInitial = function (model, productGroupId) {
...
physicalPlot.InitSeriesData = function (propertyId) {
    ...
    $("#diagPhysicalPropertyName").html(oneSerieName);
    $("#diagPhysicalPropertyHeading").html(oneSerieName);

    //console.log('Series Data Init', seriesData);
}

var selectedSourcePropertyIdDiagram = null;
var selectedPropertyIdDiagram = null;

physicalPlot.PlotChart = function (propertyId, tableId, sourcePropertyId) {
    selectedSourcePropertyIdDiagram = sourcePropertyId;
    selectedPropertyIdDiagram = propertyId;

    tableDataId = tableId;
    physicalPlot.InitSeriesData(parseInt(propertyId));
    physicalPlot.ShowTableData();
    $("#" + tableId).hide();
    $("#diagPhysicalContainer").show();
    ...
    var legendWidth = 70;
    var svgContainer = "#diagPhysicalChart";

    var saveContainer = "#savePhysical";
...
physicalPlot.ShowData = function () {
    $("#diagPhysicalContainer").hide();
    $("#" + tableDataId).show();
};

physicalPlot.ShowTableData = function () {
    var html = "";
    ...
    $("#diagPhysicalTable > tbody").html(html);
};
